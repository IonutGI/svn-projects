...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/ionut/Desktop/DjangoLearning/DjangoStudy/study/database.db',# Or path to database file if using sqlite3.
...
SECRET_KEY = 'oq_dn!5lv+k86z2e=cb_an_!h=#tis6j(2d53(h*1iq(+%b(#='
